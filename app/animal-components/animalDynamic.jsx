...
// import animal2 from "../../public/images/animalpage/animal2.png";
// import animal3 from "../../public/images/animalpage/animal3.png";
// import animal4 from "../../public/images/animalpage/animal4.png";
...
//       plantSmallImage: animal1, // Path to small plant image
//     },
//     {
//       id: 2,
...
//       plantImage: plant, // Path to the plant image
//       plantSmallImage: animal2, // Path to small plant image
//     },
//     {
//       id: 3,
...
//         "Fallow land rejuvenation helps restore nutrients in the soil, enhancing crop productivity. adwadada da dwwad awd adawd aw daw dwa daw aw da d awdw awdawd awdwa dawdadadwawd dw dwadawwadaw dawdwadawd wdawdawdawdawdaw dwwa",
//       plantImage: plant, // Path to the plant image
//       plantSmallImage: animal3, // Path to small plant image
//     },
//     {
//       id: 4,
...
//         "Fallow land rejuvenation helps restore nutrients in the soil, enhancing crop productivity. adwadada da dwwad awd adawd aw daw dwa daw aw da d awdw awdawd awdwa dawdadadwawd dw dwadawwadaw dawdwadawd wdawdawdawdawdaw dwwa",
//       plantImage: plant, // Path to the plant image
//       plantSmallImage: animal4, // Path to small plant image
//     },
//     {
//       id: 5,
...
const AnimalDynamic = ({
  ...
  useEffect(() => {
    const scrollToSection = () => {
      ...
      if (hash) {
        ...
        const matchedTitle = animalTitlesItems.find((item) => {
  ...
  const handleProductClick = (productId) => {
    ...
    router.push(`/single-product/${productId}?category=animal`);
  };  
        ...
        return {
          ...
          filteredProducts: products.filter((product) =>
            product.applicationTitleSection?.some(
              (sectionItem) => `Animal-${activeTitle}-${section.id}` === sectionItem.generatedText
            )
          )
        };
      });
              ...
              <div>
                ...
                >
                  ...
                  >
                    ...
                    <Image
                      src={section.animalSmallImage}
                      alt="small plant"
                      className={`absolute ${
                        isLastSection
                          ? isEven
                            ? "top-[120%] right-[-15%]" // Even, last section: move image down and to the right
                            : "top-[120%] right-[72%]" // Odd, last section: move image down and further to the right
                          : isEven
                          ? "top-[95%] left-[90%]" // Even, not last section: default position
