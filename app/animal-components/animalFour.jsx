...
import plantsmall from "../../public/images/animalpage/animal4.png";
...
const Agriculturefour = ({ activeTitle }) => {
  ...
  return (
    <section className="2xl:ml-36 xl:ml-28 font-poppins" key={activeTitle}>
      ...
      <div className="relative lg:flex flex-row item-center justify-center space-x-10 lg:mx-10 hidden ">
        {/* First Left */}
        ...
        <div className="absolute inset-x-0 right-60 bottom-0 flex items-center justify-center pointer-events-none"data-aos="fade-down">
          <Image
            src={plantsmall}
