...
import animal1 from "../../public/images/animalpage/animal1.svg";
...
const Agriculturemain = ({activeTitle}) => {
  ...
  return (
    <section className="mt-10 font-poppins" key={activeTitle}>
      ...
      <div className="relative lg:flex flex-row items-center justify-center lg:mx-10 hidden space-x-11">
  {/* First Left */}
  <div className="flex items-center gap-6" data-aos="fade-up">
    <div className="flex flex-col items-center">
      <Image
        src={plant}
        alt="rounded plant image"
        data-aos="zoom-in"
      />
    ...
    <div className="flex-col space-y-5 max-w-[300px]">
      ...
      <p className="text-[#000] font-extralight text-[14px]" data-aos="fade-left">
        Lorem ipsum Dior amet Lorem ipsum Dior amet Lorem ipsum Dior amet Lorem ipsum Dior amet Lorem ipsum Dior amet.
      </p>
      <button
        className="px-7 py-3 border-2 border-[#193048] text-[#193048] font-poppinsSB rounded-md flex items-center space-x-2"
  ...
  >
    ...
    <div className="grid grid-cols-2 gap-4 max-w-[400px] min-h-[300px] below-1146:min-h[100px] below-1146:max-w-[500px] rounded-2xl">
      {cardList.slice(currentIndex, currentIndex + 2).map((card) => (
        <div key={card.id} className="max-w-[200px] flex flex-col h-full rounded-2xl">
  ...
  <div className="absolute inset-x-0 bottom-[-20px] flex items-center justify-center pointer-events-none " data-aos="fade-down">
    <Image
      src={animal1}
    ...
    />
      ...
      <div className="lg:flex hidden items-center justify-center  below-1276:scale-90 below-1276:ml-[15px] below-1276:mt-[-20px] below-1146:scale-75 below-1146:mr-[5%] below-1146:mt-[-40px] below:1085p:mr[-40px] below-1085:mt-[-60px] below-1030:mt-[-65px]">
  <svg
    width="1500"
    height="225"
