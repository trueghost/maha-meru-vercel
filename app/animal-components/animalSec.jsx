...
import plantsmall from "../../public/images/animalpage/animal2.png";
...
const Agriculturesec = ({ activeTitle }) => {
  ...
  return (
    <section className="2xl:ml-36 xl:ml-28 font-poppins" key={activeTitle}>
      ...
      <div className="relative lg:flex flex-row item-center justify-center space-x-24 lg:mx-10 hidden below-1146:mb-10 ">
        {/* First Left */}
        ...
        <div className="absolute inset-x-0 right-40 bottom-[-20px] flex items-center justify-center pointer-events-none"data-aos="fade-down">
          <Image
            src={plantsmall}
