...
import plant from "../../public/images/agriculture page/agriculture/walk.png";
...
const Agriculturefinal = ({ nextTitle, setNextTitleActive, scrollToLargeComponent, activeTitle }) => {
  ...
  return (
    <section className="pb-24 font-poppins" key={activeTitle}>
      ...
      <div className="lg:flex flex-row item-center justify-center lg:mx-10 hidden relative">
        {/* First Left */}
        ...
        {/* Right Part with Cards */}
          ...
          <div className={`flex items-start ${isCardVisible?'opacity-100': 'opacity-0' }`}>
            ...
            {/* Next Button */}
            <button
              className="bg-[#1F3B59] h-10 w-10 rounded-full font-poppinsSB flex justify-center items-center text-white ml-2 mt-36"
              onClick={handleNext}
            >
              &gt;
            </button>
          </div>
          <div className="absolute inset-x-0 bottom-[-40px] left-9 flex items-center justify-center pointer-events-none" data-aos="fade-down">
    <Image
      src={plantsmall}
    ...
    `}
        ...
        <div className="relative">
          <button className="w-[300px] py-5 bg-[#1F3B59] font-poppinsSB absolute text-2xl text-[#E6CFB7] rounded-2xl" onClick={handleNextTitle}>
          {nextTitle}{" "}
          </button>
        </div>
      </div>
      ...
      <div className="lg:hidden flex flex-row justify-center items-center   gap-5  pb-5 mx-5 font-poppins">
      ...
      <div className="flex flex-col items-center space-y-4 font-poppinsSB mt-5 lg:hidden">
