...
import plant from "../../public/images/agriculture page/agriculture/leaf.png";
...
const Agriculturefour = ({activeTitle}) => {
  const cardList = [
    {
      id: 1,
      title: "M-Terraboost",
  ...
  return (
    <section className="2xl:ml-36 xl:ml-28 font-poppins" key={activeTitle}>
      ...
      <div className="lg:flex flex-row item-center justify-center space-x-10 lg:mx-10 hidden relative ">
        {/* First Left */}
        ...
        <div className="flex items-center gap-6 " data-aos="fade-up">
          ...
          <div className="flex-col space-y-5 max-w-[300px]">
            <h2 className="text-[#000] font-bold font-poppinsSB text-[22px]"data-aos="fade-left">
            Larval Support
            </h2>
            ...
            <button
              className="px-7 py-3 border-2 font-poppinsSB border-[#193048] text-[#193048] rounded-md flex items-center space-x-2"data-aos="fade-down"
        ...
        <div className="absolute inset-x-0 bottom-[-10px] right-52 flex items-center justify-center pointer-events-none" data-aos="fade-down">
          <Image
            src={plantsmall}
    ...
    <style>
      ...
      <div className="lg:hidden flex flex-row-reverse justify-center items-center   gap-5  pb-5 mx-5">
        ...
        <div
          ...
          data-aos="fade-up"
        >
          <h1 className="font-extrabold text-[#000] font-poppinsSB text-[18px]  text-left">
          Larval Support
          </h1>
...
export default Agriculturefour;
