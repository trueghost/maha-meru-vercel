...
import plantsmall from "../../public/images/aquaticpage/fish1.png";

const Agriculturemain = ({activeTitle}) => {
  ...
  return (
    <section className="mt-10 font-poppins" key={activeTitle}>
      {/* First Part  Main Agriculture */}
      <div className="lg:flex flex-row item-center justify-center lg:mx-10 hidden relative space-x-11">
        {/* First Left */}
        <div className="flex items-center gap-6" data-aos="fade-up">
          ...
          <div className="flex-col space-y-5 max-w-[300px]">
            <h2 className="text-[#000] font-bold text-[22px] font-poppinsSB" data-aos="fade-left">
              {activeTitle}
            </h2>
            <p className="text-[#000] font-extralight text-[14px]" data-aos="fade-left">
              Lorem ipsum Dior amet Lorem ipsum Dior amet Lorem ipsum Dior amet
              Lorem ipsum Dior amet Lorem ipsum Dior amet Lorem ipsum Dior amet
              .
            </p>
            <button className="px-7 py-3 border-2 font-poppinsSB border-[#193048] text-[#193048] rounded-md flex items-center space-x-2" onClick={toggleCardVisibility}  data-aos="fade-down">
              See Products
              <span className="border-2 border-[#193048] font-poppinsSB rounded-full w-6 h-6 flex items-center justify-center ml-5">
                &gt;
              </span>
            </button>
          </div>
        ...
        <div className={`flex items-start below-1146:scale-80 ${isCardVisible?'opacity-100': 'opacity-0'  }`}>
        ...
        <div className="absolute inset-x-0 bottom-[-30px] left-9 flex items-center justify-center pointer-events-none" data-aos="fade-down">
    <Image
      src={plantsmall}
    ...
    <style>
      ...
      <div className="lg:hidden flex flex-row justify-center items-center   gap-5  pb-5 mx-5">
        ...
        >
          ...
          <button
            className="px-4 sm:px-7 py-2 sm:py-3 font-poppinsSB border-2 border-[#193048] text-[#193048] rounded-md flex items-center justify-center space-x-2 mt-3 sm:mt-0"
            onClick={toggleCardVisibility}
          >
            See product
            <span className="border-2 border-[#193048] font-poppinsSB rounded-full w-5 h-5 sm:w-6 sm:h-6 flex items-center justify-center ml-2 sm:ml-5">
              &gt;
            </span>
          </button>
        </div>
