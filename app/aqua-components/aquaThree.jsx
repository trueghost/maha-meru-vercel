...
const Agriculturethree = ({activeTitle}) => {
  ...
  return (
    <section className="font-poppins" key={activeTitle}>
      ...
      <div className="lg:flex flex-row item-center justify-center lg:mx-10 hidden relative ">
        ...
        <div className="absolute inset-x-0 bottom-[-10px] left-9 flex items-center justify-center pointer-events-none" data-aos="fade-down">
    <Image
      src={plantsmall}
