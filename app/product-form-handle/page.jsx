...
export default function ProductFormHandleAdmin() {
    ...
    async function deleteFormHandle(id) {
        try {
            const response = await fetch(`/api/product-form-handle/${id}`, {
                method: 'DELETE',
            });
            if (!response.ok) {
        ...
        <Protect>
            <div className="min-h-screen flex flex-col bg-gray-100">
                ...
                <div className="flex flex-1">
                    {isSidebarOpen && <SidebarAdmin totalItems3={formHandles.length} />}
                    <div className="flex-grow p-6">
                        <h1 className="text-3xl font-bold mb-4 text-black">Product Form Handle Admin</h1>
